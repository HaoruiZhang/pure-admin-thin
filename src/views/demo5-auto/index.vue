  ...
  <div class="stereo-container">
    ...
    <main class="main-area">
      ...
      <div class="chat-content">
        ...
        <!-- 浮动操作按钮（工作流生成） -->
        <div v-if="currentChat.messages.length > 0" class="floating-action">
          <div class="workflow-card">
            <div class="workflow-title">帮我生成一份XXX分析的标准工作流</div>
...
const conversationList = ref<Conversation[]>([
  {
    ...
    subTitle: "我想做SAW聚类分析",
    group: "today",
    messages: [{ id: 101, role: "user", content: "我想做SAW聚类分析" }]
  },
  {
    id: 2,
    title: "数据分析助手",
