<template>
  <div class="stereo-container">
    <!-- 1. Left Navigation Strip (unchanged) -->
      ...
      <div class="chat-content">
        ...
        <div class="bot-intro">
          ...
          <div class="suggestion-chips">
            <div class="chip">你能为我做什么？</div>
            <div class="chip">基于选择的Group对象执行差异分析</div>
            <div class="chip">上传文档完成AI智能解析</div>
        ...
        <div class="input-box">
          ...
          <div class="input-footer">
            ...
            <div class="right-tools">
              <el-button type="primary" color="#a78bfa" circle>
...
const conversationList = ref<Conversation[]>([
  {
    ...
    group: "today",
    messages: [
      { id: 101, role: "user", content: "帮我生成一份SAW分析的标准工作流" }
    ]
  },
  {
    id: 2,
    ...
    group: "today",
    messages: [
      { id: 201, role: "user", content: "这里有许多缺失值，怎么处理？" },
      {
        id: 202,
        role: "assistant",
  ...
  },
  {
    ...
    group: "7days",
    messages: [{ id: 301, role: "user", content: "Vue3 用什么UI库比较好？" }]
  },
  {
    id: 4,
    title: "API 接口文档解析",
...
// --- 3. State Management ---
const activeId = ref(1); // Default to the first one
...
.nav-strip {
  ...
  .nav-item {
    ...
    &.active {
      color: #fff;
      background-color: #333; /* Dark active state like in screenshot */
  ...
  .history-scroll {
    ...
    .time-group {
      ...
      .history-item {
        ...
        &.active {
          color: #333;
          background-color: #e8e8e8; /* Light gray active selection */
        }
...
.message-row {
  ...
  &.assistant {
    ...
    .bot-bubble {
      ...
      border-radius: 2px 12px 12px; /* Sharp top-left */
    }
  }
  ...
  &.user {
    ...
    .bubble {
      ...
      line-height: 1.5;
      color: white;
      background-color: #4f5a70; /* Dark slate blue color from image */
